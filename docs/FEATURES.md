...
### Phase 1 완료 / Phase 2
- **Phase 1**: **테스트 모드** 구현 완료. 배치·테스트 화면에서 「물품 1개 흐름」 버튼으로 입고→컨베이어(방향)→출고 경로 시연.
- **시뮬레이션 모드·기본 지표**는 Phase 2에서 구현. 계획은 [docs/PROJECT.md](PROJECT.md) Phase 2 참고.
...
| **배치·테스트** | 그리드: 입고/출고/컨베이어/기계1, 정사각형 셀·줌·상단/사이드 패널. 배치·삭제·저장. **물품 1개 흐름** 테스트 |
